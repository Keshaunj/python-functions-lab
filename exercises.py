...
print('Exercise 1:', calculate_area_triangle(10, 7))
...
print('Exercise 2:', simple_interest(1000, 5, 7))
...
print('Exercise 3:', apply_discount(100, 7))
...
print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temperature(2, 'C'))
print('Exercise 4: Convert 32°F to Celsius:', convert_temperature(90, 'F'))
